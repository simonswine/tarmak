...
// CoreClient is used to interact with features provided by the api.wing.tarmak.io group.
type CoreClient struct {
	restClient rest.Interface
}

func (c *CoreClient) Instances(namespace string) InstanceInterface {
...
func setConfigDefaults(config *rest.Config) error {
	g, err := scheme.Registry.Group("api.wing.tarmak.io")
	if err != nil {
		return err
	}
