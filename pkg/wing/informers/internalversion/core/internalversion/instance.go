...
import (
	...
	internalversion "github.com/jetstack/tarmak/pkg/wing/listers/core/internalversion"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.Core().Instances(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.Core().Instances(namespace).Watch(options)
			},
		},
		&wing.Instance{},
		resyncPeriod,
