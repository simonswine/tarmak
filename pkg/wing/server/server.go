...
const defaultEtcdPathPrefix = "/registry/wing.kubernetes.io"
...
func (o WingServerOptions) Config() (*apiserver.Config, error) {
	...
	o.RecommendedOptions.SecureServing.ForceLoopbackConfigUsage()
	o.RecommendedOptions.Authentication.SkipInClusterLookup = true
	o.RecommendedOptions.SecureServing.BindPort = 8088
